...
export const LUCK_TIERS = {
  great: {
    ...
    icon: Star,
    badgeClass:
      "bg-emerald-50/90 text-emerald-800 ring-emerald-200/70 backdrop-blur-sm",
  ...
  good: {
    ...
    icon: Sun,
    badgeClass:
      "bg-sky-50/90 text-sky-800 ring-sky-200/80 backdrop-blur-sm",
  ...
  bad: {
    ...
    icon: CloudRain,
    badgeClass:
      "bg-slate-100/90 text-slate-600 ring-slate-200/80 backdrop-blur-sm",
